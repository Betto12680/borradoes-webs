# Correcciones — Vitalmente Centro Médico & Psicología

**Carpeta:** `vitalmente-centro-medico-psicologia`
**Fecha:** 2026-07-21
**Versión:** borrador v2 (reescritura profunda)

## Datos del brief

- **Nombre:** Vitalmente Centro Médico & Psicología
- **Nicho:** Salud Integral / Clínica
- **Ciudad:** Ciudad de México (CDMX)
- **Teléfono:** +52 55 5540 6677 (WhatsApp: 525555406677)
- **WhatsApp:** +525555406677
- **Rating Google:** 4.8 estrellas
- **Reseñas Google:** 27
- **Paleta:**
  - Primario: `#2563eb`
  - Secundario: `#60a5fa`
...
```json
{
  ...
  "@type": "MedicalClinic",
  "name": "Vitalmente Centro Médico & Psicología",
...
1. Fachada de clínica médica con cruz iluminada, acceso principal amplio, 4K.
2. Interior de consultorio médico con escritorio, estetoscopio, ordenador, diplomas en pared, sin paciente, 4K.
3. Equipo médico especializado (cardiólogo: electrocardiógrafo; general: tensiómetro) sobre fondo desenfocado, 4K.
4. Recepción de clínica médica con mostrador, sala de espera visible al fondo, 4K.
5. Pasillo clínico limpio con luz LED, puertas de consultorios numerados, 4K.
6. Retrato editorial de médico especialista (hombre/mujer 35-55 años) con bata blanca, estetoscopio, fondo desenfocado, 4K.
