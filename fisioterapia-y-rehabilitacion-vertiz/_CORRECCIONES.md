# Correcciones — Fisioterapia y Rehabilitación Vértiz

**Carpeta:** `fisioterapia-y-rehabilitacion-vertiz`
**Fecha:** 2026-07-21
**Versión:** borrador v2 (reescritura profunda)

## Datos del brief

- **Nombre:** Fisioterapia y Rehabilitación Vértiz
- **Nicho:** Fisioterapia / Medicina Deportiva
- **Ciudad:** Ciudad de México (CDMX)
- **Teléfono:** +52 55 5605 9876 (WhatsApp: 525556059876)
- **WhatsApp:** +525556059876
...
```json
{
  ...
  "name": "Fisioterapia y Rehabilitación Vértiz",
