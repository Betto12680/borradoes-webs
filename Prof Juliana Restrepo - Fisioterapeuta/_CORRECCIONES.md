# Correcciones — Prof Juliana Restrepo - Fisioterapeuta

**Fecha:** 2026-07-21
**Versión:** borrador v2 (tras auditoría)
**Dirección:** Consultar Maps
**Teléfono:** Consultar
...
La web actual usa `tel:` en CTAs. Cambiar a `wa.me/` con texto predefinido. Teléfono queda como canal secundario.
