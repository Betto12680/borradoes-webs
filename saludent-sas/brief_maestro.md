# Brief de Desarrollo Web: Saludent SAS

## 1. Información del Cliente
- **Nombre**: Saludent SAS
- **Nicho**: Ortodoncista
- **Ciudad**: Neiva, Huila, Colombia
- **Teléfono de Contacto**: 3185571033 (WhatsApp: 523185571033)
- **Calificación en Google Maps**: 1.6 Estrellas
- **Cantidad de Reseñas**: 7 reseñas
...
- **Hero Titular**: Atención Médica de Excelencia en Neiva, Huila, Colombia
